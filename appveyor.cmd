...
if "%platform%" == "x86" set Qt5_DIR=C:\Qt\5.15.2\msvc2019\lib\cmake\Qt5
if "%platform%" == "x64" set Qt5_DIR=C:\Qt\5.15.2\msvc2019_64\lib\cmake\Qt5
mkdir build
cd build
...
if "%playform%" == "x86" set Qt5_DIR=C:\Qt\5.15.2\mingw81\lib\cmake\Qt5
if "%playform%" == "x64" set Qt5_DIR=C:\Qt\5.15.2\mingw81_64\lib\cmake\Qt5
