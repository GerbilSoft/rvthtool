...
// Debug: Unused (XS04)
static const RVL_Cert_RSA2048 cert_dpki_xs04 = {
	// Signature
	{
	 BE32_CONST(RVL_CERT_SIGTYPE_RSA2048),	// Signature type
	 // Signature
...
// Debug: Unused (CP05)
static const RVL_Cert_RSA2048 cert_dpki_cp05 = {
	// Signature
	{
	 BE32_CONST(RVL_CERT_SIGTYPE_RSA2048),	// Signature type
	 // Signature
...
const RVL_Cert *cert_get(RVL_Cert_Issuer issuer)
{
	static const RVL_Cert *const certs[RVL_CERT_ISSUER_MAX] = {
		...
		(const RVL_Cert*)&cert_dpki_xs04,	// RVL_CERT_ISSUER_DPKI_XS04
		(const RVL_Cert*)&cert_dpki_cp05,	// RVL_CERT_ISSUER_DPKI_CP05
...
unsigned int cert_get_size(RVL_Cert_Issuer issuer)
{
	static const unsigned int cert_sizes[RVL_CERT_ISSUER_MAX] = {
		...
		(unsigned int)sizeof(cert_dpki_xs04),	// RVL_CERT_ISSUER_DPKI_XS04
		(unsigned int)sizeof(cert_dpki_cp05),	// RVL_CERT_ISSUER_DPKI_CP05
